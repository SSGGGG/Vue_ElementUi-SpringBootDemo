...
// 接口地址，其中process.env.API_URL的字段值在/config/xxx.env.js文件中
...
// 获取角色列表
export const getRoleList = params => {return Axios.get(`${BASE_PATH}/role/list`, {params: params}).then(res => res.data) };