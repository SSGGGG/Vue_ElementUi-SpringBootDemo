<template>
  <div id="users">
    ...
    <!-- 表格显示数据，其中每个<el-table-column>的prop字段绑定后台返回结果的字段，@selection-change绑定一个change()方法 -->
    ...
    <!-- 编辑信息框，其中:visible.sync为boolean值，判断是否显示 -->
